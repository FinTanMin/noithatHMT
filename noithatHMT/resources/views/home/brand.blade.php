...
<div class="w-full flex flex-col items-center ">
    <div class="w-full bg-gray-800  mt-[130px] p-12">
        <div class="text-4xl text-center font-bold text-white ">Thương hiệu</div>
    </div>
    <div class="w-full p-12">
        <div class="w-full flex flex-col m-8">
            <div class="flex flex-row">
                <div class="text-4xl w-1/3 font-bold mb-1 ml-2 ">
                    SAINT LOUIS
                </div>
                <div class="h-[1px] bg-gray-400 w-full mt-4"></div>
                <div class="w-1/6 mt-1 ml-1">
                    <a href="/home/brand1">Xem tất cả</a>
                </div>
            </div>
        ...
        <div class="w-full  flex flex-col ml-12 ">
            <div class="flex flex-row">
                <div class="text-4xl mt-1 w-1/3 font-bold ">
                    CIRE TRVDON
                </div>
                <div class="h-[1px] bg-gray-400 w-full  mt-6"></div>
                <div class="w-1/6 mt-3 ml-1">
                    <a href="/home/brand2">Xem tất cả</a>
                </div>
            </div>
            <div class=" grid grid-cols-3">
            ...
            <div class="w-full flex flex-col mt-6">
                <div class="flex flex-row">
                    <div class="text-4xl w-1/4 font-bold mr-1">
                        ARCAHORN
                    </div>
                    <div class="h-[1px] bg-gray-400 w-full mt-6"></div>
                    <div class="w-1/6 mt-3 ml-1">
                        <a href="/home/brand3">Xem tất cả</a>
                    </div>
                </div>
                <div class=" grid grid-cols-3">
