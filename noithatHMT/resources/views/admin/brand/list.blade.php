...
<div class="w-full flex flex-col items-center ">
    ...
    <div class="w-4/5 text-white ">
        <h4 class="text-3xl text-red-400 text-center  ">Brand List</h4>
        <div class=" pt-3">
            <table class="   border border-slate-950     ">
                ...
                <tr>
                    ...
                    <th class="border border-slate-600 px-12">Brand Name</th>
                ...
                @foreach($brand as $obj)
                    <tr class="items-center justify-center text-center">
                        ...
                        <td class="border border-slate-600">
                            <a href="/admin/brand/delete/{{$obj->id}}"><button type="button" class="mb-2 hover:text-red-400"  id="delete">
                                    Delete
